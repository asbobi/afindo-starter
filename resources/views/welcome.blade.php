...
<body class="layout-light side-menu overlayScroll">
        ...
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="#"><img class="dark"
                        src="{{ asset('assets/img/logo_dark.png') }}" alt="svg"><img class="light"
                        src="{{ asset('assets/img/logo_white.png') }}" alt="img"></a>
                        ...
                        <div class="dropdown-custom">
                            ...
                            <div class="dropdown-wrapper dropdown-wrapper--large">
                                <ul class="list-settings">
                                    <li class="d-flex">
                                        <div class="mr-3"><img src="{{ asset('assets/img/mail.png') }}"
                                                alt=""></div>
                                    ...
                                    <li class="d-flex">
                                        <div class="mr-3"><img src="{{ asset('assets/img/color-palette.png') }}"
                                                alt=""></div>
                                        <div class="flex-grow-1">
                                            <h6>
                                    ...
                                    <li class="d-flex">
                                        <div class="mr-3"><img src="{{ asset('assets/img/home.png') }}"
                                                alt=""></div>
                                        <div class="flex-grow-1">
                                            <h6>
                                    ...
                                    <li class="d-flex">
                                        <div class="mr-3"><img src="{{ asset('assets/img/video-camera.png') }}"
                                                alt=""></div>
                                        <div class="flex-grow-1">
                                            <h6>
                                    ...
                                    <li class="d-flex">
                                        <div class="mr-3"><img src="{{ asset('assets/img/document.png') }}"
                                                alt=""></div>
                                        <div class="flex-grow-1">
                                            <h6>
                                    ...
                                    <li class="d-flex">
                                        <div class="mr-3"><img src="{{ asset('assets/img/microphone.png') }}"
                                                alt=""></div>
                                        <div class="flex-grow-1">
                                            <h6>
    ...
    <script src="{{ asset('assets/vendor_assets/js/trumbowyg.upload64.min.js') }}"></script>
